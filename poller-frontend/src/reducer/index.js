...
import isError from './error-reducer'

import Loading from './loading-reducer.js'
export default combineReducers({ publicPolls, userPolls, auth0Token, userProfile, loggedIn, storageLoginAttempt, Loading, isError})